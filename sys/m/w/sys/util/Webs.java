...
public class Webs {
    ...
    public static boolean isAjax(){
        String header = Mvcs.getReq().getHeader("X-Requested-With");
        String contentType = Strings.sNull(Mvcs.getReq().getContentType());
        return ((header != null && "XMLHttpRequest".equals(header)) || (contentType.indexOf("application/x-www-form-urlencoded") > -1));
    }
    ...
    public static DataSource getDataSource() {
        return ioc().get(DruidDataSource.class, "dataSource");
    }
