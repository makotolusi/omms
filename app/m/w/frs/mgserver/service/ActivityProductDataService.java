...
public class ActivityProductDataService extends
	...
	public Object getActivityProcut(String activityId, String res) {
		...
		for (ActivityProductData a : as) {
			String url=getProductImageUrl(a.getPicUrl1(),res);
			a.setPicUrl1(url);
		}
	...
	public String getProductImageUrl(String imageUrl,String res) {
		return picHandlerService.getQiniuPrivateUrl(imageUrl,
