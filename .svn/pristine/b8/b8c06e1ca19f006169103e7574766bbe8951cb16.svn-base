...
<%-- <link rel="stylesheet" href="<c:url value='/js/easyui/themes/black/easyui.css'/>?v=1.3.3" type="text/css" media="screen" /> --%>
...
<link rel="stylesheet" href="<c:url value='/js/easyui/extension/portal/portal.css'/>?v=4.1.7" type="text/css" media="screen" />
...
<script type="text/javascript" src="<c:url value='/js/easyui/extension/portal/jquery.portal.js'/>?v=1.3.3"></script>
