...
<head>
	<script type="text/javascript">
		var autoSyncWithProjectTree = true;
		var targetTableOption = {
				id        : 'dg-${lowerDomainName}';
				...
				onLoadSuccess : function(data){
					if(isProjectSelected){
						$('#dg-${lowerDomainName}-add').linkbutton('enable');
					}else{
						$('#dg-${lowerDomainName}-add').linkbutton('disable');
					}
					$('#dg-${lowerDomainName}-update').linkbutton('disable');
					$('#dg-${lowerDomainName}-del').linkbutton('disable');
				},
				onSelect : function(index, row){
					$('#dg-${lowerDomainName}-update').linkbutton('enable');
					$('#dg-${lowerDomainName}-del').linkbutton('enable');
				},
		...
		$(function(){
			$('#dg-${lowerDomainName}').wxgrid(targetTableOption);
		});
	</script>
</head>
<body>
