 ...
 */
@Table("commerce_User")
public class CommerceUser extends WrapSupport implements Serializable,IdEntity,
		Constable {
	...
	public enum Role {
		AGENT(0, "经销商"), VIP(1, "VIP"), MEMBER(2, "普通会员");

		private final Integer index;

		private final String Value;

		private Role(Integer index, String value) {
			this.index = index;
			Value = value;
		}
